...
namespace StargateAPI.Business.Commands
{
    ...
    public class CreateAstronautDutyHandler : IRequestHandler<CreateAstronautDuty, CreateAstronautDutyResult>
    {
        ...
        {
            //Think you can merge this into one query instead of two using the join used in getpeople
            ...
            //Get most up to date record on person
            ...
            //Now we need to update the persons history

            query = $"SELECT * FROM [AstronautDuty] WHERE {person.Id} = PersonId Order By Id Desc";
